...
import { useCategoriesQuery} from "../../service/categoryApi";
...
export default function CategoryList() {
  const { data: fetchedCategories, error, isLoading } = useCategoriesQuery();
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "icon",
      render: (icon: string) => <img src={icon} alt="" />,
  ...
  const tableProps = {
    dataSource: fetchedCategories?.data,
    columns: columns,
