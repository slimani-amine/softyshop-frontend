import {
  ...
  import {
    useOrdersQuery,useUpdateOrderMutation,
    useSearchOrdersQuery, usePaiedOrderMutation , useDeleteOrdersMutation
...
import { ADMIN } from '@src/global_roles_config';
  ...
  export default function CategoryList() {
    ...
    const { data: fetchedSearchOrders} =
      useSearchOrdersQuery(numberOrder);
    ...
    const columns = [
      ...
      },
      {
        ...
        key: 'id',
        render: (totalAmount: string) => <p className='price-td' >{totalAmount}    dt</p>,
