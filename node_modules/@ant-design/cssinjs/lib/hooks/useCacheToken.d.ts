...
export declare const getComputedToken: <DerivativeToken = object, DesignToken = DerivativeToken>(originToken: DesignToken, overrideToken: DesignToken, theme: Theme<any, any>, format?: ((token: DesignToken) => DerivativeToken) | undefined) => any;
/**
